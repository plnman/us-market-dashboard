...
class SectorHeatmapCollector:
    ...
    def __init__(self):
        ...
        self.sector_stocks = {
             ...
             'Healthcare': ['UNH', 'JNJ', 'LLY', 'ABBV', 'MRK', 'TMO', 'PFE', 'DHR'],
             'Energy': ['XOM', 'CVX', 'COP', 'SLB', 'EOG', 'MPC', 'PSX', 'VLO'],
             'Consumer Disc.': ['AMZN', 'TSLA', 'HD', 'MCD', 'NKE', 'SBUX', 'LOW', 'TJX'],
             'Consumer Staples': ['PG', 'COST', 'PEP', 'KO', 'WMT', 'PM', 'MO', 'CL'],
             'Industrials': ['CAT', 'UNP', 'HON', 'UPS', 'GE', 'DE', 'LMT', 'BA'],
             'Materials': ['LIN', 'SHW', 'APD', 'FCX', 'ECL', 'NEM', 'CTVA', 'DOW'],
             'Utilities': ['NEE', 'SO', 'DUK', 'SRE', 'AEP', 'D', 'PEG', 'ED'],
             'Real Estate': ['PLD', 'AMT', 'EQIX', 'CCI', 'PSA', 'O', 'VICI', 'WELL'],
             'Comm. Services': ['GOOGL', 'META', 'NFLX', 'DIS', 'CMCSA', 'TMUS', 'VZ', 'T'],
        }
